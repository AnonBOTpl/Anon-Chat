...
/**
 * Root configuration of a single chat tab.
 */
...
public class ChatTabConfig {
    ...
    private ChatTabProperties properties;
    ...
    public static ChatTabConfig createServerTab() {
        return new ChatTabConfig(0, "SERVER", new ChatTabProperties(""));
    }

    public static ChatTabConfig createCustomTab(final String name) {
        return new ChatTabConfig(0, "CUSTOM", new ChatTabProperties(name));
    }
